...
$lang['editor_bak']            = 'Sicherung auf meta/&lt;namespace&gt;.ckgdoku speichern';
...
$lang['nix_style']             = 'Für Windows-Server (Vista und später): Diese Einstellung ermöglicht den Zugang zu data\media durch ckgdoku\CKeditor\userfiles, sofern Links zu media und file erfolgreich in userfiles angelegt wurden.';
$lang['no_symlinks']           = 'Automatische Erstellung symbolischer Links unter ckgdoku/userfiles deaktivieren.';
$lang['direction']             = 'Einstellen der Sprach-Richtung in CKeditor: <b>nocheck</b>: ckgdoku nimmt keine Einstellungsänderungen der Default-Richtung vor;  <b>dokuwiki</b>: die aktuelle Dokuwiki Sprach-Richtung; <b>ltr</b>: von links nach rechts ; <b>rtl</b>: von rechts nach links.';
...
$lang['nofont_styling']        = 'Font Styles (= Schriftschnitt) im Editor als Plugin-Markup anzeigen. Weitere Informationen auf der ckgdoku-Plugin-Seite unter Dokuwiki.org.';
