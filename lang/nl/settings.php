...
$lang['editor_bak']            = 'Sla backup op in meta/&lt;namespace&gt;.ckgdoku';
$lang['create_folder']         = 'Activeer knop Aanmaken map in bestandsverkenner (y/n)';
$lang['dwedit_ns']             = 'Comma gescheiden lijst van namespaces waarbij ckgdoku automatisch terugschakeltnaar de oorspronkelijke DokuWiki Editor.';
...
$lang['nix_style']             = 'Voor Windows Servers (Vista en later).  Deze parameter maakt het mogelijk om data\media te benaderen met ckgdokuckeditor\userfiles, indien links naar media en bestand succesvol aangemaakt zijn in userfiles';
$lang['no_symlinks']           = 'Desactiveer automatische creatie van symbolische links in ckgdoku/userfiles.';
$lang['direction']             = 'Zet de schrijf en lees richting van de taal in FCKeditor:  <b>nocheck</b>: geen wijziging van de verstekwaarde in ckgdoku;  <b>dokuwiki</b>:  gebruik de Dokuwiki taal schrijfrichting;  <b>ltr</b>: Links-naar-rechts; <b>rtl</b>: Rechts-naar-links.';
...
$lang['nofont_styling']        = 'Toon lettertypestijlen in de editor als plugin markup. Voor details, zie de ckgdoku-pluginpagina van Dokuwiki.org.';
