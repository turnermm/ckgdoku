...
$lang['editor_bak']            = 'meta/&lt;namespace&gt;.ckgdoku にバックアップを保存';
...
$lang['nix_style']             = 'Windowsのサーバー（Vista以降）用の設定。この設定を有効にすると userfiles にメディアとファイルへのリンクを正常に作ることができる場合に、data\media に ckgdoku\CKeditor\userfiles でアクセスできるようにします。';
$lang['no_symlinks']           = 'ckgdoku/userfiles にシンボリックリンクを自動で作成しない';
$lang['direction']             = 'CKeditorでの文字の方向:  <b>nocheck</b>: ckgdokuはデフォルトの方向の設定を変更しない。  <b>dokuwiki</b>:  Dokuwikiの文字の方向の設定に従う。  <b>ltr</b>: 左から右。 <b>rtl</b>: 右から左。';
...
$lang['nofont_styling']        = 'エディター内はプラグインのマークアップで指定されたフォントスタイルで表示する。詳細は、Dokuwiki.org の ckgdoku プラグインページを参照してください。';
