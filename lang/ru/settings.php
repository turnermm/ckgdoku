...
$lang['editor_bak']            = 'Сохранить резервную копию/&lt;namespace&gt;.ckgdoku';
$lang['create_folder']         = 'Включить кнопку создания папки в файловом браузере (да/нет)';
$lang['dwedit_ns']             = 'Разделение запятыми список имен и/или страниц, где ckgdoku автоматически переключается на родной Вики редактор; принимает частичные совпадения.';
$lang['auth_ci']               = 'Нечувствительный к регистру Логин id, так что можно войти и как USER и как user.';
$lang['nix_style']             = 'Для серверов Windows (Vista и более поздние версии). Этот параметр делает возможным доступ к данным\медиа через ckgdoku\CKeditor\Пользовательские файлы, если ссылки на медиа и файлы были успешно создан в пользовательских файлах.';
$lang['no_symlinks']           = 'Отключить автоматическое создание символических ссылок в ckgdoku/Пользовательских файлах.';
$lang['direction']             = 'Установить языковое направление в CKeditor. <b>nocheck</b>: ckgdoku оставит направление языка по умолчанию; <b>dokuwiki</b>: примет языковые настройки стандартного редактора Dokuwiki; <b>ltr</b>: С лева на право ; <b>rtl</b>: С права на лево.';
