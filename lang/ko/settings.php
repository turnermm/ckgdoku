...
$lang['editor_bak']            = 'meta/&lt;namespace&gt;.ckgdoku에 백업을 저장';
$lang['create_folder']         = '파일 브라우저에서 폴더 만들기 버튼 활성화 (y/n)';
$lang['dwedit_ns']             = 'ckgdoku가 네이티브 도쿠위키 편집기로 자동으로 전환할 이름공간 및/또는 문서의 쉼표로 구분된 목록; 부분적인 일치를 허용합니다.';
...
$lang['nix_style']             = 'Windows 서버 (Vista 이상)를 위해 이 설정은 미디어와 파일로의 링크가 성공적으로 userfiles에 만들어지는 경우, ckgdoku\CKeditor\userfiles를 통해 data/media에 접근할 수 있도록 합니다';
$lang['no_symlinks']           = 'ckgdoku/userfiles에 심볼릭 링크를 자동으로 만들기를 비활성화합니다.';
$lang['direction']             = 'CKeditor에서의 언어 방향 설정:  <b>nocheck</b>: ckgdoku는 기본 방향 설정을 바꾸지 않습니다;  <b>dokuwiki</b>:  현재 도쿠위키 언어 방향;  <b>ltr</b>: 왼쪽에서 오른쪽; <b>rtl</b>: 오른쪽에서 왼쪽.';
...
$lang['nofont_styling']        = '편집기에서 글꼴 스타일을 플러그인 마크업으로 표시합니다. 자세한 내용은 Dokuwiki.org에서 ckgdoku 플러그인 문서를 보세요.';
...
$lang['extra_plugins']         = '도구 모음에 추가할 추가적인 Ckeditor 플러그인의 쉼표로 구분된 목록. 자세한 사항은 ckgdoku 플러그인의 <a href=\'https://www.dokuwiki.org/plugin:ckgdoku:configuration#extra_plugins\'>설정 문서</a>를 보세요';
