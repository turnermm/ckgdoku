...
$lang['editor_bak'] = "Save backup to meta/&lt;namespace&gt;.ckgdoku";
$lang['create_folder'] = "Enable folder creation button in file browser (y/n)";
$lang['dwedit_ns'] = "Comma separated list of namespaces and/or pages where ckgdoku automatically switches " .
...
$lang['nofont_styling']  = 'Display font styles in editor as plugin markup. See the ckgdoku plugin page at Dokuwiki.org for details.';
...
$lang['extra_plugins']  = "Comma separated list of additional Ckeditor plugins to be added to toolbar.  See ckgdoku plugin's <a href='https://www.dokuwiki.org/plugin:ckgdoku:configuration#extra_plugins'>config page</a>  for details";
