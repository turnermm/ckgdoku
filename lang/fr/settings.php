...
$lang['editor_bak']            = 'Sauve le backup sur meta/&lt;namespace&gt;.ckgdoku';
$lang['create_folder']         = 'Activer le bouton de création de dossier dans le navigateur de fichier (o/n)';
$lang['dwedit_ns']             = 'Liste des namespaces, séparés par des virgules, et/ou des pages où ckgdoku bascule automatiquement sur l\'éditeur natif de DW; Accepte les correspondances partielles.';
...
$lang['nix_style']             = 'Pour les serveurs Windows Servers (Vista et suivants). Ce paramètre rend possible l\'accès à "data\media" à travers "ckgdoku\CKeditor\userfiles", si les liens aux medias et fichiers ont été créés avec succès dans "userfiles"';
$lang['no_symlinks']           = 'Désactive la création automatique des liens symboliques dans ckgdoku/userfiles';
$lang['direction']             = 'Définit la direction de langue dans CKeditor:  <b>nocheck</b>: ckgdoku ne fera aucun changement au paramètre de direction par défaut; <b>dokuwiki</b>: le paramètre courant de Dokuwiki de direction de langue; <b>ltr</b>: Gauche-à-droite; <b>rtl</b>: Droite-à-gauche.';
